...
# See docs/v0.5.x_cb_oom_plan.md "Test / verify plan".
#
...
parity_mode () {
  ...
  echo "[run_cb_oom] === $tag 1/3 graph capture (FULL, buffer, drain ON) ==="
  # GPU pressure is now bounded by the capture ring itself (VLLM_HOOK_RING_GPU_BYTES,
  # default 4 GiB) — the CaptureDrainManager budget knobs this test used were removed.
...
# ============================================================
# (e) INFLIGHT — proactive admission cap
# ============================================================
echo "============================================================"
...
# ============================================================
# (f) FRACTION — fraction budget resolves lazily post-KV-carve
# ============================================================
echo "============================================================"
